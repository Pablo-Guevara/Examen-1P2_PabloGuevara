...
public class InicioSesion extends javax.swing.JFrame {
    ...
    public InicioSesion() {
        ...
        historial.add("Inicio historial");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextUsuario.getText().equals("") || jTextContraseña.getText().equals("")) {
            ...
            if (jTextUsuario.getText().equals("Admin") || jTextContraseña.getText().equals("1234")) {
                ...
                registrarUsuarios regU=new registrarUsuarios();
                for (int i = 0; i < regU.listaUsuarios.size(); i++) {
                    if (regU.listaUsuarios.get(i).getNombreUsuario().equals(jTextUsuario.getText())&&
                            regU.listaUsuarios.get(i).getContraseña().equals(jTextContraseña.getText())) {
                        usuarioVentana usV=new usuarioVentana();
                        usV.setVisible(true);
                    }
                }
            }
